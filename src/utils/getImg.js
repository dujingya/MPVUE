const setShareImg = (id, a, b, c, goodsname, goodsmoney, goodstype) => {
    ...
    // 广告语
    ctx.setFontSize(28)
    const bannerStr = 'Surpise健康商城  一种健康的生活方式'
    ...
    const imgurl = require('../image/qixiu/detail/share-img-bottom.jpg')
