<template>
    <div id="homePage" style="height: 100%;">
        <div :class="notScroll? 'box preventTouchMove' : 'box'">
            ...
            <div class='package' v-if="tabsPackageList && tabsPackageList.length>0">
                ...
                <view class="classification">
                    <view :class="['tabs' ,tabsPackageList.length === 1 ? 'tabs1' : 'tabs2', item.selectedItem]" v-for="(item, index) in tabsPackageList" :key="index" @click="packageItemChange(item, index)">
                        {{item.name}}
                    </view>
                </view>
                <view class="classification-page">
                    <view class="classification-list" v-for="(item, index) in classList"  :key="item.price+index">
                        <view class="card" >
                        ...
                        <view :id="'bg'+item.id" v-if="item.showContent" class="collapse"  >
                            <!--<view class="title">Surpise健康</view>-->
            ...
            <div style="font-size: 14px;padding: 20px 0;text-align: center; color: #ccc;background: #f5f5f5">Surpirse提供技术支持</div>
        </div>
        ...
        getPackageClass() { // 获取分类
            ...
            fetch({
                ...
                if (res.data.head.faultcode === 'ok') {
                    ...
                    //     id: '-1'
                    // }]
                    this.tabsPackageList = [...res.data.body]
